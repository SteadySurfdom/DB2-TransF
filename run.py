...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, required=True, default='DB2-TransF',
                        help='model name, options: [iTransformer, iInformer, iReformer, iFlowformer, iFlashformer, DB2-TransF ]')
    ...
    parser.add_argument('--levels', type=int, default=4, help='number of decompositions')
